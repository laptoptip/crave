...
void BitcoinGUI::createActions()
{
	...
	urgeMarketAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Urge Market"), this);
	urgeMarketAction->setToolTip(tr("Browse the Market."));
	urgeMarketAction->setCheckable(true);
	tabGroup->addAction(urgeMarketAction);

	buysPageAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Urge Purchases"), this);
	buysPageAction->setToolTip(tr("Show my Urge Buys."));
	buysPageAction->setCheckable(true);
	tabGroup->addAction(buysPageAction);

	sellsPageAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Urge Sells"), this);
	sellsPageAction->setToolTip(tr("Show my Urge Sells."));
	...
	connect(urgeMarketAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
	connect(urgeMarketAction, SIGNAL(triggered()), this, SLOT(gotoUrgeMarket()));
...
void BitcoinGUI::gotoUrgeMarket()
{
	//urgeMarketAction->setChecked(true);
	//centralStackedWidget->setCurrentWidget(urgeMarket);
	...
	urgeMarket = new UrgeMarket(this);
	centralStackedWidget->addWidget(urgeMarket);
	centralStackedWidget->setCurrentWidget(urgeMarket);
